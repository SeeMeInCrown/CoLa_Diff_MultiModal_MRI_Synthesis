...
class GaussianDiffusion:
    ...
    def training_losses_synthesis(self, model, classifier, x_start, t, model_kwargs=None, noise=None):
        """
        ...
        res_t = self.q_sample(res, t, noise=noise)     #add noise to the channel
        x_t=x_start.float()
        x_t[:, -1:, ...]=res_t.float()
        terms = {}
